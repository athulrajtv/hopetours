    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form id="jQueryValidationForm" method="post" action="{{ route('admin.adventure.create') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
        ...
        <div class="table-responsive mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.adventure.Editpage', $data->id) }}" class="btn btn-success">Edit</a>
                    </td>
                    <td>
                        <a href="{{ route('admin.adventure.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                    </td>
