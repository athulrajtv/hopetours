    ...
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body p-4">
                <form id="jQueryValidationForm" method="post" action="{{ route('admin.recommended.create') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label for="input35" class="col-sm-3 col-form-label">Place</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="input35" name="place" placeholder="" value="{{ old('place') }}">
                            @error('place')
        ...
        <div class="table-responsive mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.recommended.Editpage', $data->id) }}" class="btn btn-success">Edit</a>
                    </td>
                    <td>
                        <a href="{{ route('admin.recommended.delete', $data->id) }}" class="btn btn-danger">Delete</a>
                    </td>
