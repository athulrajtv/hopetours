            ...
            <div class="card-body p-4">
                <form id="jQueryValidationForm" method="post" action="{{ route('admin.gallery.create') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="input35" name="details" placeholder="" value="{{ old('details') }}">
                            @error('details')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
        ...
        <div class="table-responsive mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.gallery.Editpage', $data->id) }}" class="btn btn-success">Edit</a>
                    </td>
                    <td>
